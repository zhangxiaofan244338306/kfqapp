...
define([
  ...
  function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented, template, on, Deferred,
    ...
    var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      _onBtnClear:function(){
        document.getElementById("dijit_form_ValidationTextBox_0").value='';
        document.getElementById("dijit_form_FilteringSelect_0").value='';
        document.getElementById("dijit_form_FilteringSelect_1").value='';
        document.getElementById("dijit_form_FilteringSelect_2").value='';
        document.getElementById("dijit_form_FilteringSelect_3").value='';
        document.getElementById("dijit_form_FilteringSelect_4").value='';
        document.getElementById("dijit_form_FilteringSelect_5").value='';
